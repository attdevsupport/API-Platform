...
8) MerchantPaymentRedirectUrl        : https://wincode-api-att.com/R2-Csharp-WrapperApplication/payment/app2/Default.aspx

9) IsPurchaseOnNoActiveSubscription  : false

10) SubscriptionRecurringNumber      : 99999
...
14) subscriptionDetailsFilePath      : //R2-Csharp-WrapperApplication//payment//app2//subscriptionDetails.txt

15) subscriptionRefundFilePath       : //R2-Csharp-WrapperApplication//payment//app2//subscriptionRefund.txt

16) subscriptionNotificationFilePath : //R2-Csharp-WrapperApplication//payment//app2//subscriptionNotification.txt

17)applicationName                   : CS_PAYMENT_APP2

18)grantType                         : client_credentials

19)log_path                          : /R2-Csharp-WrapperApplication/Log/
...
Suppose you copied the sample app files in your IIS server webroot/payment/app2/ folder, In order to run the sample application, type in'http://IIS_HOSTNAME:8080/payment/app2/Default.aspx'(assuming you're using a HOSTNAME machine with IIS Server and have not changed the default port number, otherwise adjust accordingly) on your browser.
