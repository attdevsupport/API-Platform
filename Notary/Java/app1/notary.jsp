...
String url = FQDN + "/Security/Notary/Rest/1/SignedPayload?client_id=" + clientIdAut + "&client_secret=" + clientSecretAut;
...
if(statusCode==200) {
    ...
    if(request.getParameter("return")!=null)
        response.sendRedirect("payment.jsp?signedPayload=" + signedPayload + "&signature=" + signature);
} else {
