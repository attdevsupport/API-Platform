...
if(redirectUriTemp==null)
	redirectUriTemp = "http://ec2-23-20-126-146.compute-1.amazonaws.com:8080/MOBO/oauth.jsp";
...
<input type="submit" name="getExtCode" value="Get Access Token" />
   ...
   <%   
   	   if(getExtCode!=null) {
    		session.setAttribute("subjectTextBox", request.getParameter("subjectTextBox"));
    		session.setAttribute("messageTextBox", request.getParameter("messageTextBox"));
    		session.setAttribute("groupCheckBox", request.getParameter("groupCheckBox"));
    		session.setAttribute("phoneTextBox", request.getParameter("phoneTextBox"));
