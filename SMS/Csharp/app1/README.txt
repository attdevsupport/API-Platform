...
Suppose you copied the sample app files in your IIS server webroot/sms/app1/ folder, In order to run the sample application, type in'http://IIS_HOSTNAME/sms/app1/Default.aspx'
