...
3. Parameters
   ...
   6) $oauth_file = "/tmp/wapoauthtoken.php"  : Oauth Token persistance location, should be writable by Apache server  
   7) $scope = "SMS";                         : Oauth scope ( SMS ) 
   8) $default_address                        : Default phone number 
   9) $default_subject                        : Default text message
   10) $default_url                           : Default url
